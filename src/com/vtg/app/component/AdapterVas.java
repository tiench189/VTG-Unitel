...
public class AdapterVas extends BaseAdapter {
	private Context mContext;
	private List<ModelVas> listVas;
	private LayoutInflater inflater;

	public AdapterVas(Context context, List<ModelVas> listVas) {
	...
	@Override
	public ModelVas getItem(int position) {
		// TODO Auto-generated method stub
		return listVas.get(position);
	}
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (view == null) {
			view = inflater.inflate(R.layout.row_vas, null);
		...
		ModelVas vas = getItem(position);
		holder.tvName.setText(vas.name);
		holder.tvDescription.setText(vas.description);
